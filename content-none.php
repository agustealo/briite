...
<section class="work no-results not-found">
	...
	<div class="page-content">
		<?php if ( is_home() && current_user_can( 'publish_posts' ) ) : ?>
			...
			<p>
				...
				printf(
					...
					wp_kses_post( __( 'Ready to publish your first post? <a href="%1$s">Get started here</a>.', 'kriate' ) ),
		...
		<?php else : ?>
			...
			<p><?php esc_html_e( 'It seems we can&rsquo;t find what you&rsquo;re looking for. Perhaps searching can help.', 'kriate' ); ?></p>
			<?php get_search_form(); ?>
