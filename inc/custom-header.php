 ...
 *
 * @uses kriate_header_style()
 * @uses kriate_admin_header_style()
 * @uses kriate_admin_header_image()
 */
function kriate_custom_header_setup() {
	add_theme_support( 'custom-header', apply_filters( 'kriate_custom_header_args', array(
 ...
 *
 * @see kriate_custom_header_setup().
 */
...
endif; // kriate_admin_header_style
...
endif; // kriate_admin_header_image
